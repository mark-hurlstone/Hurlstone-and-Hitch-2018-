...
%             for i=1:parms.Grouping(l) 
%                 j=j+1;
%                 pogMarkers(r,j) = fminparms.ItemDistinct.^abs(g-l);
%             end
%         end
%     end
% end
...
%             for l=1:parms.Grouping(k)
%                 j=j+1;
%                 pwgMarkers(r,j) = fminparms.ItemDistinct.^abs(p-l);
%             end
%         end
%     end
% end
...
% % Weighting and normalisation
% %--------------------------------------------------------------------------
% pogMarkers = fminparms.ItemWeight * ...
%     (pogMarkers./repmat(sum(pogMarkers'),parms.ll,1)');
% pwgMarkers = fminparms.ItemWeight * ...
%     (pwgMarkers./repmat(sum(pwgMarkers'),parms.ll,1)');
% 
% % Weight position-within-sequence and position-within-group markers
% markers = (1-parms.Sg).*pogMarkers+parms.Sg.*pwgMarkers;
% 
